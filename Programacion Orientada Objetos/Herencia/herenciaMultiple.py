...
#La herencia múltiple consiste en que una clase tiene varios padres
#Para llamarlos se usa el nombre de la propia clase padre no con super
#Podemos tener problema si en las clases padres hay atributos o metodos que se llamen igual
